...
Für den Entwurf der GUI wurde sich maßgeblich an der Referenztabelle, siehe Anhang \ref{abb:Ausgangstabelle} die in der \nameref{sec:Analysephase} entwickelt wurde Orientiert. Darraus wurde ein webtauglicher Entwurf erstellt der vorallen die Navigation des Monats, im gegensatz zur Excel Tabelle, über Schaltflächen realisiert. Den GUI Entwurf siehe Anhang \ref{abb:GUIEntwurf}.
